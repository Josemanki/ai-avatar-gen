...
const server = z.object({
  ...
  APP_AWS_CLIENT_ACCESS_KEY: z.string().min(1),
  APP_AWS_CLIENT_SECRET_KEY: z.string().min(1),
  APP_AWS_REGION: z.string().min(1),
  APP_AWS_S3_BUCKET_NAME: z.string().min(1),
...
const processEnv = {
  ...
  APP_AWS_CLIENT_ACCESS_KEY: process.env.APP_AWS_CLIENT_ACCESS_KEY,
  APP_AWS_CLIENT_SECRET_KEY: process.env.APP_AWS_CLIENT_SECRET_KEY,
